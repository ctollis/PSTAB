...
foreach($_POST as $nombre => $valor )
{
	...
	{	
		...
		$Consulta=$estadistica->ejecutaQuery("INSERT INTO pstab.egresos(nombre_apellido_e, f_n_e, lugar_nacimiento_e, edad_e, sexo_e, fecha_e, motivo_e, docente, grado, seccion, mes, ano) VALUES ('$var1' , '$var2' , '$var3' , '$var4' , '$var5' ,' $var6' , '$var7', '$docente', '$grado', '$seccion', '$mes', '$ano')");
			$i=1;
			if (!$Consulta) {
	 		...
	 		echo "<script type='text/javascript'> 
				alert('Estadistica registrada satisfactoriamente!');
        		location='../vista/estadisticas.php'
        		</script>";	
