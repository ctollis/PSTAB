...
<body>
		...
		<div id="estadistica">	
		<h3>ESTADISTICAS MENSUALES</h3><br>
		<form action="../controlador/proEstadistica1.php" method="POST">
		
		<table width="70%" border=2 cellspacing="8" id="estadistica1">
			
			<tr><td align=center>Docente: <input type="text" name="docente" maxlength="32" > </td>
 			<td align=center>Grado:<select name="grado">  
				<option value=""></option>
			...
			&nbsp&nbsp&nbspTurno&nbsp<select name="seccion">
				<option value=""> </option>
		...
		<tr>
		<td align=center>Mes: <select name="mes" id="mes">
			<option value=""></option>
		...
		<td colspan="1" align=center>Dias h&aacutebiles <input type="text" size="5" name="dias_habiles"></td>
		</tr>

		<tr><td align="right" colspan="2"><br><input type="submit" value="Guardar y continuar" name="guardar"></td></tr>
		</table>
	</form>
</body>
</html>
